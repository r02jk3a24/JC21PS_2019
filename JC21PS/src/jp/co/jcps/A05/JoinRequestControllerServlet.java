...
public class JoinRequestControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// SQLを宣言
		String sql = "SELECT * FROM mst_club WHERE club_id NOT IN (SELECT club_id FROM trn_join_request WHERE user_id = ?)"
				+ " AND club_id NOT IN (SELECT club_id FROM trn_club_member WHERE user_id = ?);";
