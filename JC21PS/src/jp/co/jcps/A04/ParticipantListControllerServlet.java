...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT mst_user.user_name, trn_activity.activity_name FROM mst_user LEFT OUTER JOIN trn_participant on (mst_user.user_id = trn_participant.user_id ) LEFT OUTER JOIN trn_activity on (trn_activity.activity_id = trn_participant.activity_id) WHERE trn_participant.activity_id = ? ";
		// SQLに埋め込むパラメータリストを定義
