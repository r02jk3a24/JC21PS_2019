...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT mst_user.user_name,trn_activity.activity_name FROM trn_activity INNER JOIN trn_participant ON trn_activity.activity_id = trn_participant.activity_id INNER JOIN mst_user ON trn_participant.user_id = mst_user.user_id WHERE trn_participant.activity_id = ?;";
