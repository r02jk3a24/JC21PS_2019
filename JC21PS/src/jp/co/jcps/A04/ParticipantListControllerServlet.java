...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT activity_name , user_name FROM jc21ps_2020_6.trn_participant JOIN jc21ps_2020_6.trn_activity USING(activity_id) JOIN jc21ps_2020_6.mst_user USING(user_id) WHERE activity_id = ? ";
