...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT activity_name, user_name FROM jc21ps_2020_2.trn_activity i inner join jc21ps_2020_2.trn_participant n on i.activity_id = n.activity_id inner join jc21ps_2020_2.mst_user s on n.user_id = s.user_id where i.activity_id = ? ";
