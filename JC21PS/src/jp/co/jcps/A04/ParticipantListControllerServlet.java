...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT trn_activity.activity_name,mst_user.user_name FROM trn_activity JOIN (mst_user join trn_participant USING (user_id) ) USING (activity_id) where activity_id = ? ;";
