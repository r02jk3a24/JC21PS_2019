...
public class JoinApprovalSaveServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String registUserId = request.getParameter("trn_join_request.user_id");
	...
	private void saveClubMember(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "INSERT INTO trn_club_menber(club_id=? OR user_id=?)";
	...
	private void deleteJoinRequest(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "DELETE FROM trn_join_request WHERE club_id=? OR user_id=?";
