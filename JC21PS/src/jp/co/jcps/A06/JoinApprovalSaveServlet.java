...
public class JoinApprovalSaveServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String registUserId = (String)request.get().get("userClubId");
	...
	private void saveClubMember(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "INSERT INTO trn_club_menber(club_id,user_id) SELECT club_id,user_id FROM trn_join_request";
	...
	private void deleteJoinRequest(String registClubId, String registUserId) throws Exception {
		...
		//SQLを宣言
		// TODO: SQL文を完成させなさい。
		String sql = "DELETE FROM trn_join_request WHERE user_id,club_id";
