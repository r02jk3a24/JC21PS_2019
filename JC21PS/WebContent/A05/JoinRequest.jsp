  ...
  <form action="/JC21PS/JoinRequestSave" method="POST">
  	...
  	<table class='table table-bordered'>
  		...
  		<tr>
  			...
  			<td colspan="1"><button type='submit' name='registClubId'  value='<%=bean.getClubNameList()  %>' onclick="return confirm('申請しますか？')">部員登録申請</button></td>
  		</tr>
  		<tr>
  			<td colspan ="2"><%= bean.getClubNameList() %></td>
  		<%} %>
  		</tbody>
  	</table>
  	</div>
