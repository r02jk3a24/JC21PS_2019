  ...
  <form action="/JC21PS/JoinRequestSave" method="POST">
  	...
  	<table class='table table-bordered'>
  		...
  		<tr>
  			...
  			<td colspan="1"><button type='submit' name='registClubId'  value='<%= 1 %>' onclick="return confirm('申請しますか？')">部員登録申請</button></td>
  		</tr>
  		<tr>
  			<td colspan ="2"><%= bean.getClubDescriptionList().get(i) %></td></tr>
  		<% } %>
  		</tbody>
  	</table>
  	</div>
